...
def main():
    ...
    for i in range(10):
        ...
        if i%4==0:
            gold=[10,10,110,40]; tt="text"; inst="click the File menu"
        elif i%4==1:
            gold=[200,70,240,100]; tt="icon"; inst="select the save icon"
        elif i%4==2:
            gold=[80,200,120,260]; tt="text"; inst="open the sidebar panel"
        else:
            gold=[W-180,H-60,W-40,H-10]; tt="text"; inst="check the status bar"
        name=f"mock_{i}.png"
